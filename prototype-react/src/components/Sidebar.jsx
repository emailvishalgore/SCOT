    ...
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
      ...
      <div className="sidebar-header">
        ...
        <div className="sidebar-brand">
          ...
          <span className="sidebar-subtitle">Wing Champions</span>
        </div>
        <button 
      ...
      <div className="sidebar-nav">
        ...
        <div className="nav-section">
          <span className="nav-label">Organizer Tools</span>
          {organizerLinks.map((link, idx) => {
          ...
          <div className="nav-section">
            ...
            {adminLinks.map((link, idx) => {
              ...
              return (
                <motion.div
                  key={link.screen}
                  custom={idx + organizerLinks.length}
                  variants={navLinkVariants}
                  initial="initial"
                  animate="enter"
                >
